---
title: Monitoring and Debugging Spark Applications
description: Symptom-to-treatment reference for common Spark failure modes - slow tasks, slow joins/aggregations, OOM errors, and serialization errors - plus Spark UI and logging tools.
tags:
  - reference
---
