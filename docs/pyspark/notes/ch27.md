---
title: Regression Models in MLlib
description: Reference for MLlib regression models - linear, generalized linear, decision tree, random forest/GBT, and survival regression - with hyperparameters and evaluators.
tags:
  - reference
---
