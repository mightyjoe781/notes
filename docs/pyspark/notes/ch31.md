---
title: Deep Learning with Spark
description: Explains the ways to use deep learning with Spark (inference, transfer learning, distributed training) and surveys the ecosystem of deep learning libraries.
tags:
  - concept
---
...
![Image Classification with Convolutional Neural Networks | by ...](../assets/13fA77_mLNiJTSgZFhYnU0Q2x.png)
