---
title: Recommendation with Alternating Least Squares
description: Reference for Spark's ALS collaborative filtering algorithm - hyperparameters, cold-start handling, and evaluation with regression and ranking metrics.
tags:
  - reference
---
