---
title: Unsupervised Learning Models in MLlib
description: Reference for MLlib clustering and topic modeling - k-means, bisecting k-means, Gaussian Mixture Models, and Latent Dirichlet Allocation.
tags:
  - reference
---
...
print(kmModel.summary.trainingCost)  # computeCost deprecated in Spark 3.x
