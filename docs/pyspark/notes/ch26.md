---
title: Classification Models in MLlib
description: Reference for MLlib classification models - logistic regression, decision trees, random forests, GBTs, and Naive Bayes - with their hyperparameters and evaluators.
tags:
  - reference
---
