...
description: Explains what stream processing is, its use cases and challenges, and design tradeoffs like event-time vs processing-time and micro-batch vs continuous execution.
tags:
  - concept
---
