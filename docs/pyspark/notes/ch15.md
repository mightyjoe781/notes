---
title: How Spark Runs on a Cluster
description: Explains Spark's driver/executor/cluster-manager architecture, execution modes, and how an application's lifecycle breaks into jobs, stages, and tasks.
tags:
  - concept
---
...
Spark currently supports 3 cluster managers: Standalone, Apache Mesos, and Hadoop YARN.
