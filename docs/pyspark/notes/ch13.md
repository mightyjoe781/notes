---
title: Advanced RDDs Cheatsheet
description: Reference for key-value RDD operations - aggregation methods (reduceByKey vs groupByKey), cogroups, joins, custom partitioning, and Kryo serialization.
tags:
  - reference
---
