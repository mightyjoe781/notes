---
title: Spark SQL Cheatsheet
description: Reference for Spark SQL - tables, views, databases, complex types, subqueries, and SQL configuration properties.
tags:
  - reference
---
...
````python
# Python equivalent — both DataFrame and SQL produce the same physical plan
