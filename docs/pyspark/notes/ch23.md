---
title: Structured Streaming in Production
description: Covers fault tolerance via checkpointing, safely updating running streaming applications, and monitoring streaming queries.
tags:
  - concept
---
