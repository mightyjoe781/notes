...
description: Covers indirect (cluster config, file formats, garbage collection) and direct (parallelism, caching, joins) levers for tuning Spark job performance.
tags:
  - concept
---
