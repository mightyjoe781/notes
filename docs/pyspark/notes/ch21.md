...
description: Covers Structured Streaming's core concepts - sources, sinks, output modes, triggers, and watermarks - with worked examples including Kafka and foreach sinks.
tags:
  - concept
---
