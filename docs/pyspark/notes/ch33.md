---
title: Spark Ecosystem and Community
description: Lists popular Spark packages (connectors, GraphFrames, deep learning) and community resources like Spark Summit and local meetups.
tags:
  - reference
---
...
- Use meetup.com to find groups near you!