---
title: Preprocessing and Feature Engineering Cheatsheet
description: Reference for MLlib transformers and estimators - RFormula, VectorAssembler, bucketing, scaling, indexing, one-hot encoding, text transformers, and PCA.
tags:
  - reference
---
