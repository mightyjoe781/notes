---
title: Event-Time and Stateful Processing in Structured Streaming
description: Covers event-time windows (tumbling and sliding), watermarks for late data, deduplication, and arbitrary stateful processing with mapGroupsWithState.
tags:
  - concept
---
