---
title: Datasets (Scala/Java Type-Safe Structured API)
description: Explains what Datasets are, when to trade performance for type-safety, and how they compare to DataFrames and RDDs in the JVM languages.
tags:
  - concept
---
