---
title: Absolute FreeBSD - Ch 12. The Z File System
description: Intro to ZFS's design philosophy and its three core building blocks - datasets, pools, and virtual devices.
tags:
  - concept
  - draft
---
...
A *dataset* is defined as a named chunk of ZFS data. ZFS includes snapshots, block devices for virtualization and iSCSI targets, clones and more, all of those are datasets. `zfs(8)` is used to manage all ZFS datasets. Execute `zfs list` to view all existing datasets.
