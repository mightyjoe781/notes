...
![[aws/dataeng/assets/fundamentals.excalidraw.md#^frame=IQ39uq9z|1000]]
## Data Warehouse & Data Lakes

![[aws/dataeng/assets/fundamentals.excalidraw.md#^frame=8AHS3AhF|1000]]
...
![[aws/dataeng/assets/fundamentals.excalidraw.md#^frame=x2tyJoLQ|500]]
...
![[aws/dataeng/assets/fundamentals.excalidraw.md#^frame=170AlDeA]]
...
*Definition* : ETL stands for Extract, Transform, Load. It's a process used to move data from 
source systems into a data warehouse.

![[aws/dataeng/assets/fundamentals.excalidraw.md#^frame=TEoveNZq|1000]]

### Managing ETL Pipelines

- Process must be automated in some reliable way using AWS Glue, Orchestration Services

![[aws/dataeng/assets/fundamentals.excalidraw.md#^frame=2nShuMhd|1000]]
## Common Data Sources & Data Formats

### Data Sources

![[aws/dataeng/assets/fundamentals.excalidraw.md#^frame=0sITW4Lx|1000]]
### Data Formats

![[aws/dataeng/assets/fundamentals.excalidraw.md#^frame=zm5NCAhE|1000]]
...
![[aws/dataeng/assets/fundamentals.excalidraw.md#^frame=d9ICfYMI|1000]]

## Data Sampling Techniques

![[aws/dataeng/assets/fundamentals.excalidraw.md#^frame=Isa3oLvF|1000]]
## Data Skew mechanism
...
![[aws/dataeng/assets/fundamentals.excalidraw.md#^frame=lyaImRZY|1000]]
## SQL Review
