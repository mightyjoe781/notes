---
title: ECS, Fargate, and EKS Container Fundamentals
description: Covers ECS task definitions and services, EC2 vs Fargate launch types, networking modes, and running Kubernetes on AWS with EKS.
tags:
  - reference
---
...
## See Also
- [Docker vs Virtual Machines](../../docker/concepts.md)
