---
title: Writing Tests
description: Reference on Go testing - table tests, parallel tests, code coverage, fuzzing, benchmarks, stubs, httptest, and the race detector.
tags:
  - reference
---
...
* `go test` runs the test functions in current directory
