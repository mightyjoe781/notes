---
title: Go Tooling
description: Reference on Go's CLI tooling - go run/install, linters (go vet, staticcheck, revive, golangci-lint), go generate, embedding, cross-compilation, and build tags.
tags:
  - reference
---
