...
description: Explains Go's CSP-based concurrency model - goroutines, channels, select, and best practices like WaitGroups, backpressure, and context-based cancellation.
tags:
  - concept
---
...
- [Asynchronous Programming](../../python/async.md)
- [Website Status Tracker Application](../notes/stat_trackr.md)
