---
title: "Here Be Dragons: Reflect, Unsafe, and Cgo"
description: Explains Go's reflect package for runtime type inspection, the unsafe package for direct memory manipulation, and cgo for calling C code.
tags:
  - concept
---
