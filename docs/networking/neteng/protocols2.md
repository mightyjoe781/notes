...
- Router translates the src IP address in the IP Packet with its own public IP Address, creating a NAT Table for this transmission and acting as a middleman for this communication
...
- Symmetric NAT
    ...
    - ~ kind of doesn't work with WebRTC correctly
#### STUN, TURN
